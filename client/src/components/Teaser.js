...
{/* need to fix up button, and add the text at the top (do pixel font if you can.) */}
    ...
    <img className="float-left lg h-32 w-auto"
                    src="https://i.ibb.co/7Js60Ym/Dcf.png"
                    alt="Degen Coin Flip"/>
        <p className="text-8xl  mx-4 float-left text-center ">+</p>
                    {/* Add a PLUS sign, then the Matic emblem */}
    <img src="https://i.ibb.co/Mp2DKwy/polyg2.jpg" alt="polyg2" border="0"/>
        <button tabindex="0">Select Wallet</button>
    </div>
        </div>
